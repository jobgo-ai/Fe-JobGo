...
const Template = (args) => ({
  ...
  template: `<div style="display:flex">
    ...
    <hp-badge-tag style="margin-right:8px;" label="Hello world"  icon="layers"  v-bind="args"> </hp-badge-tag>
    <hp-badge-tag style="margin-right:8px;" label="Hello world" quantity="4.0"  type="positive" v-bind="args"> </hp-badge-tag>
    <hp-badge-tag style="margin-right:8px;" label="Hello world"  icon="layers"  type="positive"  v-bind="args"> </hp-badge-tag>
    <hp-badge-tag style="margin-right:8px;" label="Hello world" quantity="4.0"  type="negative" v-bind="args"> </hp-badge-tag>
    <hp-badge-tag style="margin-right:8px;" label="Hello world"  icon="layers"  type="negative"  v-bind="args"> </hp-badge-tag>
  </div>`,
});
